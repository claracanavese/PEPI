...
simulation1 = function(i){
  ...
  first_switch[i+500] <<- fs[1,]$time
  second_switch[i+500] <<- ss[1,]$time
}
...
saveRDS(first_switch, file="./R_times/1.0_1.5_0.005_14t_fs.RData")
saveRDS(second_switch, file="./R_times/1.0_1.5_0.005_14t_ss.RData")
...
first_switch <- readRDS("./R_times/1.0_1.5_0.005_14t_fs.RData")
second_switch <- readRDS("./R_times/1.0_1.5_0.005_14t_ss.RData")
